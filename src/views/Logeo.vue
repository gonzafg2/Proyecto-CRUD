  ...
  <div class="Logeo">
    ...
    <div class="form-group mx-3">
      ...
      <input
        ...
        placeholder="ej: mi.nombre@minombre.cl"
      />
    </div>
    <div class="form-group mx-3">
      <label for="exampleInputPassword1" placeholder="Contraseña"
        >Contraseña</label
      >
      <input
        type="password"
        ...
        v-model="clave"
      />
      <small>Entre 7 y 15 caracteres, minimo una Mayuscula y un simbolo</small>
    </div>
  ...
  methods: {
    Registrar() {
      ...
      if (this.validarContraseña.test(this.clave) == true) {
        ...
        alert(
          "Contraseña Insegura, Recuerda los parametros minimos que debe tener "
        )
      }
    },
  },
